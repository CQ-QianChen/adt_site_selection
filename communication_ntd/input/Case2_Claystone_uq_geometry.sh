...
--path_to_save_sorption_data output/Case2_Claystone_uq_geometry/sorption_data \
--path_to_save_nuclide_species_data output/Case2_Claystone_uq_geometry/nuclide_data \
--path_to_save_nuclide_emitted_energy_data output/Case2_Claystone_uq_geometry/emitted_energy_data \
...
--path_to_save_sorption_data output/Case1_Claystone_Baden-Wuerttemberg/nuclide_data/sorption_data \
--path_to_save_nuclide_species_data output/Case1_Claystone_Baden-Wuerttemberg/nuclide_data \
--path_to_save_nuclide_emitted_energy_data output/Case1_Claystone_Baden-Wuerttemberg/nuclide_data \